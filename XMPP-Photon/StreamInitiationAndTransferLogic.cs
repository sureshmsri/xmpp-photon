...
namespace com.negociosit.XMPP.XMPPphoton
{
    ...
    public class StreamInitIQ : IQ
    {
        ...
        public static StreamInitIQ BuildDefaultStreamInitOffer(XMPPClient client, FileTransfer trans)
        {
            ...
            q.StreamOptions = com.negociosit.XMPP.XMPPphoton.StreamOptions.ibb;
    ...
    public class ByteStreamStreamLogic : Logic
    {
        ...
        {
            System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(DoStart));
        }
    ...
    public class SOCKS5ByteStreamLogic : ByteStreamStreamLogic
    {
        ...
        public override bool NewIQ(IQ iq)
        {
                ...
                if  ( (IQStart != null) && (iq.ID == IQStart.ID) )
                {
                    ...
                    else if (iq is ByteStreamQueryIQ)
                    {
                        ...
                        if (bsiq.Type == IQType.result.ToString())
                        {
                            ...
                            System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(SendFileThread), bsiq);
                        }
            ...
            else /// See if we are available to receive this file... Another transfer may be in progress
            {
                if (iq is ByteStreamQueryIQ)
                {
                    ...
                    {
                        System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(DownloadThread), bsiq);
                    }
                    else
                    {
            ...
            if (host.Jid != XMPPClient.JID) 
            {
                ...
                if (ConnectSuccesful == true)
                {
                    ...
                    while (FileTransfer.BytesRemaining > 0)
                    {
                        ...
                        System.Net.Sockets.SocketAsyncEventArgs asyncsend = new System.Net.Sockets.SocketAsyncEventArgs();
                        asyncsend.SetBuffer(bSend, 0, nSize);
                        asyncsend.Completed += new EventHandler<System.Net.Sockets.SocketAsyncEventArgs>(asyncsend_Completed);
        ...
        System.Threading.ManualResetEvent SendCompletedEvent = new ManualResetEvent(false);
        System.Threading.ManualResetEvent EventActivate = new ManualResetEvent(false);
        bool bSendSuccess = false;
        void  asyncsend_Completed(object sender, System.Net.Sockets.SocketAsyncEventArgs e)
        {
        ...
        System.Threading.ManualResetEvent EventGotAllData = new System.Threading.ManualResetEvent(false);
        ...
        System.Threading.ManualResetEvent EventConnected = new System.Threading.ManualResetEvent(false);
