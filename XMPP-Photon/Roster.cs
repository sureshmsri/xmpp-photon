...
namespace com.negociosit.XMPP.XMPPphoton
{
    ...
    public class RosterItemList : System.Collections.Specialized.INotifyCollectionChanged, IEnumerable<RosterItem>
    {
        ...
        public void Add(RosterItem item)
        {
            items.Add(item);
#if WINDOWS_PHONE
            FireCollectionChanged(this, new System.Collections.Specialized.NotifyCollectionChangedEventArgs(System.Collections.Specialized.NotifyCollectionChangedAction.Add, item, -1));
#else
        ...
        public void Clear()
        {
            ...
            {
                items.Clear();
                FireCollectionChanged(this, new System.Collections.Specialized.NotifyCollectionChangedEventArgs(System.Collections.Specialized.NotifyCollectionChangedAction.Reset));
            }
        }
        ...
        public void Remove(RosterItem item)
        {
            ...
            items.Remove(item);
            FireCollectionChanged(this, new System.Collections.Specialized.NotifyCollectionChangedEventArgs(System.Collections.Specialized.NotifyCollectionChangedAction.Remove, item, nPos));
        }
        ...
        void SafeFireCollectionChanged(object obj, System.Collections.Specialized.NotifyCollectionChangedEventArgs args)
        {
            CollectionChanged(obj, args);
        }
        ...
        public event System.Collections.Specialized.NotifyCollectionChangedEventHandler CollectionChanged = null;
