...
namespace com.negociosit.XMPP.XMPPphoton
{
    ...
    public class XMPPAccount : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        PresenceStatus m_eLastPrescence = new PresenceStatus() { PresenceType = PresenceType.available, PresenceShow = PresenceShow.chat, Status = "", IsDirty = true };
        [DataMember]
        public PresenceStatus LastPrescence
        {
            ...
            { 
                if (m_eLastPrescence == null)
                    m_eLastPrescence = new PresenceStatus() { PresenceType = PresenceType.available, PresenceShow = PresenceShow.chat, Status = "", IsDirty=true };
