...
namespace com.negociosit.XMPP.XMPPphoton
{
    ...
    public class FileTransfer : INotifyPropertyChanged
    {
        ...
        {
            if (this.FileTransferState == com.negociosit.XMPP.XMPPphoton.FileTransferState.Error)
                return string.Format("Error with {0} of {1} to {2}, Error: {3}", this.FileName, FileTransferDirection, RemoteJID.User, Error);

            if (this.FileTransferDirection == com.negociosit.XMPP.XMPPphoton.FileTransferDirection.Send)
        ...
        public System.Windows.Visibility IsVisibleSendCancel
        {
            ...
            {
                if (
                    (FileTransferDirection == com.negociosit.XMPP.XMPPphoton.FileTransferDirection.Send) && 
                    ((FileTransferState != com.negociosit.XMPP.XMPPphoton.FileTransferState.Done) && (FileTransferState != com.negociosit.XMPP.XMPPphoton.FileTransferState.Error))
                    )
        ...
        public System.Windows.Visibility IsAcceptCancelVisible
        {
            get
            {
                    if ((FileTransferDirection == com.negociosit.XMPP.XMPPphoton.FileTransferDirection.Receive) &&
                                       (FileTransferState == com.negociosit.XMPP.XMPPphoton.FileTransferState.WaitingOnUserAccept) )
                        return System.Windows.Visibility.Visible;
                    return System.Windows.Visibility.Collapsed;
            }
        }
        ...
        public System.Windows.Visibility IsSaveVisible
        {
            ...
            {
                    if ((FileTransferDirection == com.negociosit.XMPP.XMPPphoton.FileTransferDirection.Receive) &&
                                       (FileTransferState == com.negociosit.XMPP.XMPPphoton.FileTransferState.Done) )
                        return System.Windows.Visibility.Visible;
                    return System.Windows.Visibility.Collapsed;
            }
        }
