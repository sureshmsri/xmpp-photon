...
namespace com.negociosit.XMPP.XMPPphoton.Jingle
{
    ...
    public class Jingle
    {
        ...
        public JingleStateChange JingleStateChange
        {
            ...
            set
            {
                ...
                if (value == com.negociosit.XMPP.XMPPphoton.Jingle.JingleStateChange.Active)
                    Active = "";
                else if (value == com.negociosit.XMPP.XMPPphoton.Jingle.JingleStateChange.Hold)
                    Hold = "";
                else if (value == com.negociosit.XMPP.XMPPphoton.Jingle.JingleStateChange.Mute)
                    Mute = new Mute();
                else if (value == com.negociosit.XMPP.XMPPphoton.Jingle.JingleStateChange.Ringing)
                    Ringing = "";
                else if (value == com.negociosit.XMPP.XMPPphoton.Jingle.JingleStateChange.Unmute)
                    Unmute = new Mute();
            }
        }
    ...
    public class JingleSessionLogic : Logic
    {
        ...
        internal void NewIncomingSessionRequest(JingleIQ iq)
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem(new System.Threading.WaitCallback(FireNewSessionThreaded), iq);
        }
